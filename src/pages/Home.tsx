        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground font-light max-w-2xl mx-auto">
              Discover carefully curated pieces that blend contemporary design with timeless elegance
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            {/* Clothes Category */}
            <Link to="/shop?category=clothes" className="group relative overflow-hidden rounded-lg luxury-hover">
              <div className="aspect-[4/3] bg-gradient-to-br from-muted to-secondary flex items-center justify-center">
                <div className="text-center">
                  <h3 className="text-3xl font-light tracking-wider text-primary mb-4">CLOTHES</h3>
                  <p className="text-muted-foreground mb-6">Contemporary fashion for every occasion</p>
            ...
            {/* Jewelry Category */}
            <Link to="/shop?category=jewelry" className="group relative overflow-hidden rounded-lg luxury-hover">
              <div className="aspect-[4/3] bg-gradient-to-br from-soft-rose to-luxury-rose/30 flex items-center justify-center">
                <div className="text-center">
                  <h3 className="text-3xl font-light tracking-wider text-primary mb-4">JEWELRY</h3>
                  <p className="text-muted-foreground mb-6">Exquisite pieces crafted with precision</p>
                  <Button variant="outline" className="btn-gold group-hover:bg-premium-gold group-hover:text-primary">
                    Shop Jewelry
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
