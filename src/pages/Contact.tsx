          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-primary mb-1">Visit our showroom</h3>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div>
                  <p className="font-medium text-primary">What is your return policy?</p>
                  <p className="text-muted-foreground">30-day returns on all items in original condition.</p>
                </div>
                <div>
                  <p className="font-medium text-primary">Do you ship internationally?</p>
                  <p className="text-muted-foreground">Yes, we ship worldwide with express delivery options.</p>
                </div>
                <div>
                  <p className="font-medium text-primary">How can I track my order?</p>
