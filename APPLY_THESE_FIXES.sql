-- ============================================
-- CRITICAL FIXES - Apply via Supabase SQL Editor
-- ============================================
-- Go to: https://supabase.com/dashboard/project/ngniknstgjpwgnyewpll/sql/new
-- Copy and paste this entire file, then click "Run"
-- ============================================

-- FIX 1: Wishlist Function Type Mismatch
-- This fixes the 400 error on wishlist page
...
-- These speed up database queries significantly
